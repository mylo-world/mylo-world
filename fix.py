...
class Leaderboard:
    def __init__(self, master):
        ...
        cut = sorted_scores[:5]
        leaderboard_text = "Rank | Name | Score | time\n \n" + "\n".join(
...
class MainGame:
    def __init__(self, master, category, level):
        ...
        self.timer_label = tk.Label(frame1, text="Time: 0s", font=("Helvetica", 20), bg='purple',fg='white')
        self.timer_label.place(relx=0.9,rely=0.05, anchor='nw')
        ...
        for idx, key in enumerate(listOfKeys):
            ...
            self.game_completion_time = self.end_time - self.start_time
...
class WinWindow:
    def __init__(self, master, LoadDefs, chosenwords, level):
        ...
        definition_text = f"The definition of {chosenwords}\n{LoadDefs[chosenwords]}"
...
class LoseWindow:
    def __init__(self, master, LoadDefs, chosenwords):
        ...
        canvas = tk.Canvas(frame1, width=550, height=75, borderwidth=0, highlightthickness=0, bg="#12022b") 
        scrollbar = ttk.Scrollbar(frame1, orient="vertical", command=canvas.yview) 
        style=ttk.Style()
        ...
        canvas.place(relx=0.40, rely=0.4, anchor='center') 
        scrollbar.place(relx=0.8, rely=0.4, anchor='center', height=75)

        # scrollbar = Scrollbar(frame1) 
        # scrollbar.place(relx=0.48, rely=0.4, anchor='center', relheight=0.3) 
        ...
        # definition_text.insert('1.0', f"The Word Was {chosenwords}\n{LoadDefs[chosenwords]}") 
        # definition_text.place(relx=0.5, rely=0.4, anchor='center')

        # def _on_mousewheel(event): 
        #     definition_text.yview_scroll(int(-1*(event.delta/120)), "units") 
        # definition_text.bind_all("<MouseWheel>", _on_mousewheel)
