...
class LoseWindow:
    def __init__(self, master, LoadDefs, chosenwords):
        ...
        definition_text = f"The Word Was {chosenwords}\n{LoadDefs[chosenwords]}" 
        ...
        text_widget = Text(text_frame, wrap="word", font=(Rocabe, 15), bg="#12022b", fg="white", borderwidth=0, yscrollcommand=scrollbar.set) 
        text_widget.insert("1.0", definition_text) 
